...
interface IdeaRepository {
    suspend fun processIdea(ideaContent: String): Result<ProcessedIdeaDraft>
    suspend fun saveIdea(processedIdea: ProcessedIdeaDraft): Result<Int> // Returns the new Idea id (the app need it to navigate to the Idea detail page)
